...
public class PrescriptionalMedicins extends Medicins {
    private String activeSubstance;
    private boolean addictive;
    private int stayInBodyDuration;
    private int prescriptionValidity;

    public PrescriptionalMedicins(String name, String pharm, Certificate certificate, MedicalFulfillment fulfillment, PackageType packageType, int amount, double price, int dosage, int periodicity, String activeSubstance, boolean addictive, int stayInBodyDuration, int prescriptionValidity) {
